      ...
      >
        <SubMenu label={dictionary['navigation'].dashboards} icon={<i className='ri-home-smile-line' />}>
          <MenuItem href={`/${locale}/apps/bookly/dashboard`}>
            <img src={WhiteWordLogo.src} alt='Zerv' style={{ height: 22, marginTop: 4 }} />
          </MenuItem>
        ...
        <MenuSection label={dictionary['navigation'].appsPages}>
          ...
          <SubMenu label={<img src={GreenWordLogo.src} alt='Zerv' style={{ height: 22, marginTop: 4 }} />}>
            ...
            {/* <MenuItem href={`/${locale}/apps/bookly/businesses`}>
              {dictionary['navigation'].businesses ?? 'Businesses'}
            </MenuItem> */}
            {/* <MenuItem href={`/${locale}/apps/bookly/services`}>
              {dictionary['navigation'].services ?? 'Services'}
            </MenuItem> */}
            <MenuItem href={`/${locale}/apps/bookly/categories`}>
