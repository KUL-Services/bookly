...
export interface StaffMember {
  ...
  photo: string
  businessId: string
  branchId: string // Primary/main branch (for backward compatibility)
  branchIds?: string[] // All branches this staff is assigned to
  mainBranchId?: string // Main branch where shifts are assigned (defaults to branchId)
