      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12 pb-8 border-b border-white/10'>
          <div className='flex items-center gap-4'>
            <img src={WhiteIconLogo.src} alt='Zerv' className='w-12 h-12 sm:w-14 sm:h-14 object-contain' />
            <div>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12'>
          ...
          <div>
            <h4 className='text-sm font-semibold text-white uppercase tracking-wider mb-4'>For Businesses</h4>
            <ul className='space-y-3 text-sm'>
              <li>
                <Link href='#' className='text-white/60 hover:text-[#77b6a3] transition-colors duration-300'>
                  List Your Business
          ...
          <div>
            ...
            <ul className='space-y-3 text-sm'>
              <li>
                <Link
                  href='#'
                  className='text-white/60 hover:text-[#51b4b7] transition-colors duration-300 flex items-center gap-2'
                >
              ...
              <li>
                <Link
                  href='#'
                  className='text-white/60 hover:text-[#e88682] transition-colors duration-300 flex items-center gap-2'
                >
                  <svg className='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
              ...
              <li>
                <Link
                  href='#'
                  className='text-white/60 hover:text-[#77b6a3] transition-colors duration-300 flex items-center gap-2'
                >
                  <svg className='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
        ...
        <div className='border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4'>
          <p className='text-white/50 text-xs sm:text-sm'>© 2025 Zerv. All rights reserved.</p>
