    ...
    <div className='relative'>
      ...
      {open && (
        <>
          ...
          {/* Dropdown */}
          <div className='absolute right-0 mt-2 w-40 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-gray-200 dark:border-slate-600 p-1 z-50 animate-in slide-in-from-top-2 duration-200'>
