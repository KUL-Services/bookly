    ...
    <div className='min-h-screen w-full px-4 sm:px-6 py-6 sm:py-8 flex flex-col items-center bg-gradient-to-br from-slate-50 via-teal-50/20 to-cyan-50/10 dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900 relative overflow-hidden'>
      ...
      <div className='w-full max-w-4xl space-y-6 sm:space-y-8 relative z-10'>
            ...
            <CardTitle>
              <div className='flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6'>
                ...
                <div className='text-center sm:text-left'>
                  <H4 className='text-gray-900 dark:text-white text-xl sm:text-2xl' stringProps={{ plainText: user.name }} />
        ...
        <Card className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-xl border border-teal-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 animate-in fade-in slide-in-from-bottom-6 duration-700 animation-delay-600'>
          <CardHeader>
            <CardTitle>
              <H5 i18nTFn={t} className='text-gray-900 dark:text-white' stringProps={{ localeKey: 'profile.bookings.title' }} />
            </CardTitle>
          ...
          <CardContent>
            {(activeTab === 'upcoming' ? upcomingBookings : pastBookings).map((b, index) => (
              <div key={b.id} className={`group border border-gray-200/50 dark:border-gray-700/50 rounded-xl p-6 flex gap-4 items-start bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-800 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] animate-in fade-in slide-in-from-bottom-4 duration-500`} style={{ animationDelay: `${index * 100}ms` }}>
