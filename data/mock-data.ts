...
export const mockBusinesses: Business[] = [
  {
    ...
    about:
      "Premium hair salon offering cutting-edge styles and treatments in the heart of London.",
    services: ["1", "2", "3"],
    staff: ["1", "2", "7"],
    reviews: ["1", "2"],
    averageRating: 4.8,
  ...
  },
  {
    ...
    about:
      "Modern nail salon specializing in gel manicures, nail art, and luxury pedicures.",
    services: ["4", "5"],
    staff: ["3", "4"],
    reviews: ["3"],
    averageRating: 4.6,
  ...
  },
  {
    ...
    about:
      "Traditional barbering with a modern twist. Specialists in classic cuts and hot towel shaves.",
    services: ["6", "7"],
    staff: ["5", "6"],
    reviews: ["4", "5"],
    averageRating: 4.9,
...
export const mockReviews: Review[] = [
  ...
  },
  {
    ...
    authorImage:
      "https://images.unsplash.com/photo-1488716820095-cbe80883c496?w=50&h=50&fit=crop&crop=face",
    rating: 4,
