...
19. [Commissions (Admin)](#commissions-admin)
20. [Admin Reviews](#admin-reviews)
21. [Asset Assignments](#asset-assignments)
...
The Bookly API provides endpoints for user authentication, business management, service and resource scheduling, booking management, and more.

## Modules

1. **Authentication**: Register, Login, Password Management.
2. **Business**: Manage business profiles, settings.
3. **Services**: Manage services offered by businesses.
4. **Resources/Staff**: Manage staff and assets.
5. **Bookings**: Create and manage bookings.
6. **Scheduling**: Manage staff schedules, breaks, and exceptions.
7. **Commissions**: Manage commission rates and tracking.
8. **Admin Reviews**: Reply to and flag reviews.
9. **Asset Assignments**: Assign staff to rooms/assets.
10. **Notifications**: System and booking notifications.
11. **Admin Bookings**: Enhanced with filtering capabilities.
...
Get rapid statistics for the dashboard overview.
...
Accepts same body as user reschedule.
...
### PATCH `/admin/scheduling/schedules/{id}` 🔒
